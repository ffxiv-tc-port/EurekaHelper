    ...
    public class EurekaHydatos : IEurekaTracker
    {
        ...
        public static EurekaHydatos GetTracker()
        {
            List<EurekaFate> HydatosFates = new()
            {
                ...
                new(1424, 66, 827, 515,   "I Don't Want to Believe", "Ovni", "Ovni", new Vector2(27.1f, 29.0f), null, Vector2.Zero, EurekaWeather.None, EurekaWeather.None, EurekaElement.Unknown, EurekaElement.Unknown, false, 60, true, false, TimeSpan.FromMinutes(35)),
                new(1422, 67, 827, 515,   "The Baldesion Arsenal: Expedition Support", "Tristitia", "Support Fate", new Vector2(18.8f, 28.9f), null, Vector2.Zero, EurekaWeather.None, EurekaWeather.None, EurekaElement.Unknown, EurekaElement.Unknown, false, 60, true, false, TimeSpan.FromMinutes(35)),
        ...
        // Cheap static passthrough for callers (e.g. SplatoonManager's mutant-monster eligibility
        // check) that just need the current weather without paying for a full tracker instance
        // (which also runs GetFatePositionFromLgb over every NM in the zone).
